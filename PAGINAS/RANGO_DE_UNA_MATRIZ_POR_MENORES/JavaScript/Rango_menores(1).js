...
else{dv.textContent=" = "+paso.det;let av=document.createElement("span");av.textContent="El menor es nulo. Elige otro menor";av.style.marginLeft="10px";lm.appendChild(av);}
lm.appendChild(dv);caja21.scrollTop=caja21.scrollHeight;autoScroll();
}
