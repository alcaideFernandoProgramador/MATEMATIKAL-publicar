...
function autoScroll(){requestAnimationFrame(()=>{let c=document.getElementById("caja21");if(c&&c.scrollHeight>c.clientHeight){c.scrollTop=c.scrollHeight;}});}
...
let h=Math.max(220,Math.min(520,Math.floor(window.innerHeight*0.45)));
caja21.style.maxHeight=h+"px";caja21.style.overflowY="auto";caja21.style.overflowX="hidden";
