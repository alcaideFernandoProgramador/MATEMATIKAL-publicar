...
function _esCeroExpr(x){
  ...
  try{
    let u=_strip(t).replace(/−/g,"-");while(u.length&&u[0]==="("&&u[u.length-1]===")"){u=u.slice(1,-1);u=_strip(u).replace(/−/g,"-");}u=u.replace(/\s+/g,"");
    if(!/[a-zA-Z]/.test(u)){
      let val=null;
      if(/^[-+]?((\d+\.?\d*)|(\.\d+))(e[-+]?\d+)?$/i.test(u))val=parseFloat(u);
        ...
        /* BASE e EXP (sin '*'), donde BASE puede ser fracción, con o sin paréntesis */
        if(val==null){
          ...
          if(i>0){
            ...
            if(/^[-+]?\d+$/.test(exp)){
              ...
              let bval=null;
              if(base.includes('/')){let p=base.split('/');if(p.length===2){let a=parseFloat(p[0]),b=parseFloat(p[1]);if(Number.isFinite(a)&&Number.isFinite(b)&&b!==0)bval=a/b;}}
      ...
      /* Último recurso: eval numérica segura para formas raras como (a/b)e-14 o 10^-14 */
      if(val==null){
        try{
          let z=u;
          if(/^[0-9eE\+\-\.\*\/\(\)\^]+$/.test(z)){
...
function crearFormulario(){
  ...
  let etiquetaOpcion1=document.createElement("label");etiquetaOpcion1.htmlFor="inputcorto1";etiquetaOpcion1.innerHTML="Opción 1: Permutar el orden de dos filas";caja1211.appendChild(etiquetaOpcion1);
  let etiquetaOpcion1bis=document.createElement("label");etiquetaOpcion1bis.htmlFor="inputcorto1";etiquetaOpcion1bis.innerHTML="(F<sub>i</sub> ↔ F<sub>j</sub>)";caja1212.appendChild(etiquetaOpcion1bis);
  ...
  let etiquetaOpcion2=document.createElement("label");etiquetaOpcion2.htmlFor="inputcorto2";etiquetaOpcion2.innerHTML="Opción 2: Permutar el orden de dos columnas";caja1221.appendChild(etiquetaOpcion2);
  let etiquetaOpcion2bis=document.createElement("label");etiquetaOpcion2bis.htmlFor="inputcorto2";etiquetaOpcion2bis.innerHTML="(C<sub>i</sub> ↔ C<sub>j</sub>)";caja1222.appendChild(etiquetaOpcion2bis);
  ...
  let etiquetaOpcion3=document.createElement("label");etiquetaOpcion3.htmlFor="inputcorto3";etiquetaOpcion3.innerHTML="Opción 3: Reordenar las filas bajando las que más ceros tengan a su izquierda";caja1231.appendChild(etiquetaOpcion3);
  let etiquetaOpcion3bis=document.createElement("label");etiquetaOpcion3bis.htmlFor="inputcorto3";etiquetaOpcion3bis.innerHTML="(F↓)";caja1232.appendChild(etiquetaOpcion3bis);
  ...
  let etiquetaOpcion4=document.createElement("label");etiquetaOpcion4.htmlFor="inputcorto4";etiquetaOpcion4.innerHTML="Opción 4: Simplificar una fila dividiendo sus elementos por un número no nulo";caja1241.appendChild(etiquetaOpcion4);
  let etiquetaOpcion4bis=document.createElement("label");etiquetaOpcion4bis.htmlFor="inputcorto4";etiquetaOpcion4bis.innerHTML="(F<sub>a</sub>→1/m F<sub>a</sub>)";caja1242.appendChild(etiquetaOpcion4bis);
  ...
  let etiquetaOpcion5=document.createElement("label");etiquetaOpcion5.htmlFor="inputcorto5";etiquetaOpcion5.innerHTML="Opción 5: Cambiar una fila por una combinación lineal de ella y de otras";caja1251.appendChild(etiquetaOpcion5);
  let etiquetaOpcion5bis=document.createElement("label");etiquetaOpcion5bis.htmlFor="inputcorto5";etiquetaOpcion5bis.innerHTML="(F<sub>1</sub>=aF<sub>1</sub>+bF<sub>2</sub>+cF<sub>3</sub>)";caja1252.appendChild(etiquetaOpcion5bis);
  ...
  let etiquetaOpcion6=document.createElement("label");etiquetaOpcion6.htmlFor="inputcorto6";etiquetaOpcion6.innerHTML="Opción 6: Eliminar las filas nulas";caja1251bis.appendChild(etiquetaOpcion6);
  let etiquetaOpcion6bis=document.createElement("label");etiquetaOpcion6bis.htmlFor="inputcorto6";etiquetaOpcion6bis.innerHTML="(F<sub>nulas</sub>)";caja1252bis.appendChild(etiquetaOpcion6bis);
